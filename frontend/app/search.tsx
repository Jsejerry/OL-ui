...
export default function Search() {
  ...
  const products = data.products.filter(p => (!collectionIds || query || collectionIds.includes(p.id)) && (department === 'all' || p.department === department) && `${p.name} ${p.weight}`.toLowerCase().includes(query.trim().toLowerCase()));
